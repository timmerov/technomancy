...
namespace {
    ...
    class WorldWindowImpl : public WorldWindow, public SimpleWindow {
    public:
        WorldWindowImpl() = default;
        virtual ~WorldWindowImpl() = default;
...
WorldWindow *WorldWindow::create() throw() {
    auto impl = new(std::nothrow) WorldWindowImpl;
    return impl;
}
